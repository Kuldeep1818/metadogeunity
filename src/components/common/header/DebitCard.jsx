      ...
      <div class="card">
        <div className='card-body'>
          ...
          <div className='sidess'>
            ...
            <span className='kk'>1 $MUD = 0.00082</span>
          </div>
          ...
          <div className='ETH-USDT-box'>
            ...
            <div className='itemm'><div className='item-img'>   <img src="data:image/png;base64," height="30px" alt="item-1" /><span className='item-head'>USDT<br/> ERC20</span></div></div>
            <div className='itemm'><div className='item-img-card'>  <img src="https://fuchsia-uncertain-newt-518.mypinata.cloud/ipfs/QmTw25sGc1jZa3ZyBuY8ReTeiPd31NkSUxDzmyoNFHuYeA" height="30px" alt="item-1" /><span className='item-head'> Card</span></div></div>
          </div>
        

          <div className="side-input">
            <span><label for="title"><b>Amount in ETH you pay:</b></label>
              <input type="number" placeholder="Enter Title" name="title" id="title" /></span>
            <span><label for="title"><b>Amount in $MDU you receive</b></label>
              <input type="number" placeholder="Enter Title" name="title" id="title" ></input></span>
          </div>
